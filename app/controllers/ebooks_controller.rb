class EbooksController < ApplicationController
  ...
  before_action :load_ebook, only: [:create]
  load_and_authorize_resource

  # GET /ebooks
  # GET /ebooks.json
  def index
    @ebooks = Ebook.all.order(created_at: :desc).page(params[:page])
  end
  ...
  private
    ...
    def ebook_params
      params.require(:ebook).permit(:title, :description, :wwwlink, :summary, :frontcover, :rate)
    end
