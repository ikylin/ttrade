...
class EbooksControllerTest < ActionController::TestCase
  ...
  test "should create ebook" do
    assert_difference('Ebook.count') do
      post :create, ebook: { description: @ebook.description, summary: @ebook.summary, title: @ebook.title, wwwlink: @ebook.wwwlink }
    end
  ...
  test "should update ebook" do
    patch :update, id: @ebook, ebook: { description: @ebook.description, summary: @ebook.summary, title: @ebook.title, wwwlink: @ebook.wwwlink }
    assert_redirected_to ebook_path(assigns(:ebook))
  end
